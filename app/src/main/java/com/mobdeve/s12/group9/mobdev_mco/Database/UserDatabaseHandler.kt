...
class UserDatabaseHandler (context: Context) :
    ...
    companion object {
        ...
        private var instance: UserDatabaseHandler? = null

        @Synchronized
        fun getInstance(context: Context): UserDatabaseHandler? {
            if (instance == null) {
                instance = UserDatabaseHandler(context.applicationContext)
            }
            return instance
        }
    }
